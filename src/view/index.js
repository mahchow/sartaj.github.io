...
const page = () => `
  <article>
    <section style="background-image:url(${cover1})">
      <h1>That's what this is all about</h1>
    </section>
    <section style="background-image:url(${cover2})">This is a section</section>
    <section style="background-image:url(${cover3})">This is a section</section>
  </article>
`
